...
public class ImageRepositoryImpl implements ImageRepository {
    ...
    public List<Image> getPrimaryImagesByCategoryId(int categoryId) {
        Query query = entityManager.createQuery("select i from Image i where i.categoryImage.id=:categoryId");
        query.setParameter("categoryId", categoryId);
        return query.getResultList();
    }

    @Override
    public Image getImageByCategoryIdAndNullProductId(int categoryId) {
        Query query = entityManager.createQuery("select i from Image i where i.categoryImage.id=:categoryId and i.product.id is null ");
        query.setParameter("categoryId", categoryId);
